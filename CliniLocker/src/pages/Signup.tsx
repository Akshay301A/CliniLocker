        ...
        <div className="w-full max-w-md rounded-xl border border-border bg-card p-5 shadow-elevated sm:p-8">
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            <div>
              ...
              <Input id="labName" className="min-h-[44px]" value={form.labName} onChange={(e) => setForm({ ...form, labName: e.target.value })} placeholder="City Diagnostics" required />
            </div>
            <div>
              <Label htmlFor="phone">Phone Number</Label>
              <Input id="phone" className="min-h-[44px]" value={form.phone} onChange={(e) => setForm({ ...form, phone: e.target.value })} placeholder="+91 98765 43210" />
            </div>
            <div>
              <Label htmlFor="email">Email</Label>
              <Input id="email" type="email" className="min-h-[44px]" value={form.email} onChange={(e) => setForm({ ...form, email: e.target.value })} placeholder="lab@example.com" required />
            </div>
            <div>
              <Label htmlFor="password">Password</Label>
              <Input id="password" type="password" className="min-h-[44px]" value={form.password} onChange={(e) => setForm({ ...form, password: e.target.value })} placeholder="••••••••" required />
            </div>
            <Button
              type="submit"
          ...
          <Button
            type="button"
            variant="outline"
            className="w-full min-h-[48px] rounded-full border-primary/20 bg-white/80 text-foreground hover:bg-white"
          ...
          <Button
            variant="outline"
            className="mt-3 w-full min-h-[48px] rounded-full border-primary/20 bg-white/80 text-foreground hover:bg-white"
            asChild
          >
