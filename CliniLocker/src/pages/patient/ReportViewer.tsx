...
const ReportViewer = () => {
  ...
  /** Opens the PDF inside a mobile-only swipe-up sheet. */
                    ...
                    {pdfUrl ? (
                      <>
                        ...
                        <div className="flex h-[480px] flex-col items-center justify-center text-center p-6 md:hidden bg-muted/30">
                          ...
                          <p className="mt-1 text-sm text-muted-foreground">{t("Open the report inside CliniLocker to view or download.")}</p>
                          <div className="mt-6 flex flex-col sm:flex-row gap-3 w-full max-w-xs">
                            <Button className="gap-2 min-h-[44px]" onClick={handleOpenMobilePdf}>
