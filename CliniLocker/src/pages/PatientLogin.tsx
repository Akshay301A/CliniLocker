      ...
      <section className="flex min-h-[calc(100vh-10rem)] items-center justify-center px-4 py-8 sm:py-12">
        <div className="w-full max-w-md rounded-xl border border-border bg-card p-5 shadow-elevated sm:p-8">
          <div className="mb-5 sm:mb-6 text-center">
            <div className="mx-auto mb-3 flex h-11 w-11 sm:h-12 sm:w-12 items-center justify-center rounded-xl bg-accent text-accent-foreground">
              <Smartphone className="h-5 w-5 sm:h-6 sm:w-6" />
            </div>
            <h1 className="font-display text-xl font-bold text-foreground sm:text-2xl">Patient Login</h1>
            <p className="mt-1 text-xs sm:text-sm text-muted-foreground">Access your health reports securely</p>
          </div>
          {!otpSent ? (
