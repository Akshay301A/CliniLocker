        ...
        <AccordionItem value="data" className="rounded-2xl border border-border bg-card shadow-md overflow-hidden">
          ...
          <AccordionContent>
            <div className="px-5 md:px-6 pb-5 md:pb-6 space-y-3">
              <Button variant="default" className="w-full min-h-[48px] rounded-xl" onClick={handleExportData} disabled={exportLoading}>
                <Download className="mr-2 h-4 w-4" /> {exportLoading ? t("Exporting…") : t("Export All Data")}
              </Button>
              <Button variant="outline" className="w-full min-h-[48px] rounded-xl" onClick={handleDownloadAllReports} disabled={downloadReportsLoading}>
