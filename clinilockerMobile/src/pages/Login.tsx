      ...
      <div className="flex-1 flex items-center justify-center px-4 sm:px-6 py-8 sm:py-12">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-6 sm:mb-8">
            ...
            />
            <h1 className="font-display text-2xl sm:text-3xl font-bold text-foreground">Login your account</h1>
            <p className="mt-2 text-sm sm:text-base text-muted-foreground">Sign in to your lab dashboard</p>
          </div>
          ...
          <div className="rounded-2xl border border-border bg-card shadow-lg p-6 sm:p-8 space-y-5">
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-xs text-muted-foreground">
                <span className="bg-card px-3">Or log in with</span>
              </div>
            </div>
