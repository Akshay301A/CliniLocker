        ...
        <DialogContent className="max-w-lg">
          ...
          <div className="space-y-4">
            <div className="rounded-3xl border border-slate-200 bg-slate-50 p-4">
              ...
              <div className="mt-4">
                <Input value={doctorIdInput} onChange={(event) => setDoctorIdInput(event.target.value)} placeholder="Paste scanned doctor UUID" />
              </div>
              {doctorProfile && (
            ...
            <Button type="button" className="h-12 w-full rounded-full bg-blue-600 hover:bg-blue-700" onClick={handleSend} disabled={loading || selectedReportIds.length === 0}>
